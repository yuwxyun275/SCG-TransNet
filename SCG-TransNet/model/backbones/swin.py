...
class PatchMerging(nn.Module):
    ...
    def __init__(self, input_resolution, dim, norm_layer=nn.LayerNorm):
        ...
        # self.adapool = AdaPool2d(kernel_size=2, stride=2, beta=(1, 1))
...
class SwinEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(x.shape) torch.Size([1, 4096, 96])
        if self.ape:
        ...
        for layer in self.layers:
            ...
            if depth == 1:
                x_down1 = x
                # print(x_down1.shape) torch.Size([2, 1024, 192])
        ...
        x_down1 = x_down1.view(-1, 32, 32, 192)

        return low_level, high_level, x_down1
